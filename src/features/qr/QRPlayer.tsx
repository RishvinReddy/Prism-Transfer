    ...
    <div className="flex flex-col lg:grid lg:grid-cols-12 gap-8 w-full max-w-6xl mx-auto items-start">
      ...
      */}
      <div className="lg:col-span-8 w-full flex flex-col items-center">
        ...
        <Card className="w-full aspect-square max-w-[600px] bg-white rounded-3xl overflow-hidden flex items-center justify-center p-6 md:p-10 shadow-xl border-border/30">
          {isResetting ? (
            <div className="flex flex-col items-center justify-center text-muted-foreground w-full h-full bg-black/5 rounded-2xl border-2 border-dashed border-border/50">
               <Clock className="w-8 h-8 mb-4 animate-pulse text-primary/50" />
               <span className="font-mono text-sm uppercase tracking-widest animate-pulse">Sync Pause</span>
            </div>
          ) : (
